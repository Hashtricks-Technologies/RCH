 ...
 *  payer register, the QR codes, the role list, the Person picker), so no stray failure toast lands over the audit log. */
const BASE: Stubs = {
  ...
  "GET /api/v1/admin/qr-codes": () => json({ codes: [], hours: [] }),
};
