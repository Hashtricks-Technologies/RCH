// Rate contracts: the flow — transaction, rules, ids, history. Composes the helpers in
// apps/api/src/lib/; the arithmetic of a decision lives in packages/domain.
import type { Db } from "../../db/client.js";
import { withTransaction } from "../../lib/db.js";
import { contractsRepo } from "./repo.js";
...
export function createContractsService(db: Db) {
  return {
    ...
    async noop(): Promise<void> {
      await withTransaction(db, (tx) => contractsRepo.ping(tx));
    },
  };
}
