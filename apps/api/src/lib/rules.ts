// The 422 half of every write: the pos, availability and catalog modules refuse
...
/**
 * The transition table is data, and both sides read it. The UI hides the button;
