...
INSERT INTO "roles" ("id", "name", "desk", "perms", "active", "ever_assigned") VALUES
  ...
  ('ROLE-002', 'Outlet Manager', 'manager', '{"f":{"billing":"view","x_report":"view","shift_reports":"view","stock_ledger":"view","credit":"edit","approvals":"edit","items_stock":"edit","menu":"edit","prices":"edit","availability":"edit","item_photos":"edit"},"a":["void_bill","void_settlement","all_outlets"]}'::jsonb, true, true),
