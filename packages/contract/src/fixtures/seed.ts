...
export const seedStock: Record<StockLoc, Record<string, number>> = {
  ...
  // Finished goods only: the kitchen's raw materials and packaging are used the moment they
  // land there, so the kitchen never holds a balance of any of them.
  kitchen: { puff: 24, sand: 8, salad: 5 },
